...
#import networkx as nx                           testing1

# Import dwave_networkx for d-wave graph tools/functions
#import dwave_networkx as dnx                     testing2
...
#from dwave.system.samplers import DWaveSampler        testing3
#from dwave.system.composites import EmbeddingComposite testing 4

# sampler = EmbeddingComposite(DWaveSampler())         testing 5

# Create empty graph
#G = nx.Graph()                                       testing 6

# Add edges to graph - this also adds the nodes
# G.add_edges_from([(3, 4),(1,2)])                    testing 7

# Find the maximum independent set, S
#S = dnx.maximum_independent_set(G, sampler=sampler, num_reads=10) testing 8
